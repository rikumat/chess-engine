...
class TestBoard(unittest.TestCase):
    ...
    def test_get_diagonal_moves_returns_correct_moves(self):
        ...
        self.assertCountEqual(a1, ['a1b2', 'a1c3', 'a1d4', 'a1e5', 'a1f6', 'a1g7', 'a1h8'])

        a2 = self.board.get_diagonal_moves(test_board, "a2")
        self.assertCountEqual(a2, ["a2b1", "a2b3", "a2c4", "a2d5", "a2e6", "a2f7", "a2g8"])

        b8 = self.board.get_diagonal_moves(test_board, "b8")
        self.assertCountEqual(b8, ['b8c7', 'b8d6', 'b8e5', 'b8f4', 'b8g3', 'b8h2', "b8a7"])

        c5 = self.board.get_diagonal_moves(test_board, "c5")
        self.assertCountEqual(c5, ["c5d4", "c5e3", "c5f2", "c5g1", "c5d6", "c5e7", "c5f8", "c5b6", "c5a7", "c5b4", "c5a3"])
    ...
    def test_get_moves_from_board_returns_all_moves(self):
        test_board = [
            ["r", "n", "b", "q", "k", "b", "n", "r"],
            ["p", "p", "p", "p", "p", "p", "p", "p"],
            [".", ".", ".", ".", ".", ".", ".", "."],
        ...
        moves = self.board.get_moves_from_board(test_board, False)
